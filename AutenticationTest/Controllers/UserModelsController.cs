...
namespace AutenticationTest.Controllers
{
    public class UserModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,DisplayName,Image,ApplicationUserId")] UserModel userModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,DisplayName,Image,ApplicationUserId")] UserModel userModel)
        {
            if (ModelState.IsValid)
            {
